...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name='accounts_so_tai_khoan_cha_fkey',
        ),
        sa.PrimaryKeyConstraint('so_tai_khoan', name='accounts_pkey'),
        postgresql_ignore_search_path=False,
    )
    op.create_index(
        op.f('ix_accounts_so_tai_khoan'),
        'accounts',
        ['so_tai_khoan'],
        unique=False,
    )
    op.create_table(
        ...
        sa.UniqueConstraint(
            'ten_ky',
            name=op.f('accounting_periods_ten_ky_key'),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
    op.create_index(
        op.f('ix_accounting_periods_id'),
        'accounting_periods',
        ['id'],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['so_tai_khoan'],
            ['accounts.so_tai_khoan'],
            name=op.f('journal_entry_lines_so_tai_khoan_fkey'),
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            'so_phieu',
            name=op.f('journal_entries_so_phieu_key'),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
