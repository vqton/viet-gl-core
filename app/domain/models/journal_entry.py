...
class DetailObjectType(Enum):
    ...
    FIXED_ASSET = "TAI_SAN_CO_DINH"   # Tài sản cố định (Dùng cho TK 211, 214,...)
...
class ButToanLine:
    ...
    detail_object_id: Optional[str] = field(default=None) # Mã của đối tượng chi tiết (VD: 'KH001', 'NCC005')
