...
from sqlalchemy.orm import sessionmaker, declarative_base # <-- Cập nhật import
...
from app.infrastructure.models.sql_journal_entry import SQLJournalEntry, SQLJournalEntryLine # <-- Import các model khác nếu có
from app.infrastructure.models.sql_accounting_period import SQLAccountingPeriod # <-- Thêm import này
