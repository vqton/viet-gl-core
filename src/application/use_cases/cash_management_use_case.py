...
from src.application.dtos.cash_transaction_dto import (
    CashTransactionDTO,
    CashTransactionType,
)
...
class CashManagementUseCase:
    ...
    def execute(self, dto: CashTransactionDTO, created_by: str) -> JournalEntry:
        ...
        account, debit, credit = self._get_account_and_amounts(
            dto.transaction_type, dto.amount
        )
    ...
    def _get_account_and_amounts(
        self, transaction_type: CashTransactionType, amount: Decimal
    ):
        """
