...
def inventory_layers():
    return [
        ...
        InventoryTransaction("SKU01", Decimal('3'), Decimal('7500000'), date(2026, 4, 10), "IN")
    ]

@pytest.fixture
def lot_based_layers():
    return [
        InventoryTransaction("CAR01", Decimal('1'), Decimal('1000000000'), date(2026, 1, 1), "IN", "LOT-A"),
        InventoryTransaction("CAR01", Decimal('1'), Decimal('1050000000'), date(2026, 2, 1), "IN", "LOT-B")
    ]
...
def test_fifo_zero_quantity():
    ...
    """
    layers = [InventoryTransaction("SKU01", Decimal('1'), Decimal('1000000'), date.today(), "IN")]
...
def test_rounding_behavior():
    ...
    """
    layers = [
        InventoryTransaction("SKU01", Decimal('1'), Decimal('1000.5'), date.today(), "IN")
    ]
