    ...
    def test_ket_chuyen_cuoi_ky_don_gian(self):
        ...
        entries = [
            JournalEntry(id=1, ngay_ct=date.today(), so_phieu="BH", trang_thai="Posted", lines=[
                JournalEntryLine(so_tai_khoan="131", no=Decimal('1000'), co=Decimal('0')),
                JournalEntryLine(so_tai_khoan="511", no=Decimal('0'), co=Decimal('1000')), # Có 511: 1000
            ]),
            JournalEntry(id=2, ngay_ct=date.today(), so_phieu="CP", trang_thai="Posted", lines=[
                JournalEntryLine(so_tai_khoan="632", no=Decimal('400'), co=Decimal('0')),  # Nợ 632: 400
        ...
        accounts = {
            ...
            "131": TaiKhoan("131", "KH", LoaiTaiKhoan.TAI_SAN, 1), # Thêm TK phụ
            "156": TaiKhoan("156", "HH", LoaiTaiKhoan.TAI_SAN, 1)  # Thêm TK phụ
        }
